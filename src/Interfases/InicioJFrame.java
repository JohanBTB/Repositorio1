...
public class InicioJFrame extends javax.swing.JFrame {
    ...
    public void sonido(){
        try {
            ...
            clip.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/Musica/Menu.wav")));
            clip.start();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/menu3.gif"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        clip.stop();
        ScrollBarInicio marco = new ScrollBarInicio();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        clip.stop();
        AcercaDeJFrame ac = new AcercaDeJFrame();
        ac.setVisible(true);
        this.dispose();
